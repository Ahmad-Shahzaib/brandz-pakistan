...
export const CorporateVideo: React.FC = () => {
  ...
  return (
    <section className="relative py-16 bg-[#343538] text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 group cursor-pointer" onClick={onPlayVideo}>
          ...
          <div className="relative h-[400px] sm:h-[480px] md:h-[540px] w-full overflow-hidden">
            ...
            <div className="absolute top-6 left-6 z-10 flex items-center gap-2 bg-black/60 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20 text-xs font-bold uppercase tracking-wider text-[#F6A18F]">
              <Film className="w-4 h-4 text-[#F6A18F]" />
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center">
              <div className="relative flex items-center justify-center">
                {/* Outer Pulsing Rings */}
                <div className="absolute w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-[#F05535]/40 animate-ping" />
                <div className="absolute w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#F6A18F]/50 animate-pulse" />
                ...
                <button
                  ...
                  className="relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-tr from-[#F05535] to-[#F6A18F] hover:from-[#D34518] hover:to-[#D77A65] text-white rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 transform group-hover:scale-110 cursor-pointer border-2 border-white/40"
            ...
            <div className="absolute bottom-6 right-6 z-10 flex items-center gap-2 bg-[#F05535] hover:bg-[#D34518] text-white px-4 py-2 rounded-xl text-xs sm:text-sm font-bold shadow-lg transition-colors border border-white/20">
