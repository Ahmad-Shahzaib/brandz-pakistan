...
export const FranchiseCTA: React.FC = () => {
  ...
  return (
    <section id="franchise-cta" className="py-20 bg-[#F7F7F7] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 lg:p-16 border border-gray-200/80 shadow-xl relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 -mt-12 -mr-12 w-96 h-96 bg-[#FFF0EC] rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center relative z-10">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg border-2 border-gray-100 group">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-3.5 rounded-xl border border-white/50 flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-[#F05535] text-white flex items-center justify-center font-bold text-xs">
                      <Building2 className="w-4 h-4" />
                    </div>
                    <div>
                      <p className="font-heading font-bold text-xs text-[#343538]">Turnkey Store Setup</p>
                      <p className="text-[10px] text-[#717275]">Store Outlets Fully Operational</p>
                    </div>
                  </div>
                  <span className="text-[11px] font-bold text-[#F05535] bg-[#FFF0EC] px-2 py-0.5 rounded-md">
                    Proven ROI
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#343538] tracking-tight leading-tight">
                Join <span className="text-[#F05535]">Fri-Chiks ®</span> <br />
                & Grow Your Food Business
              </h2>

              <p className="mt-4 text-base sm:text-lg text-[#717275] leading-relaxed">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-center gap-2.5 text-xs font-bold text-[#343538] bg-[#F7F7F7] p-2.5 rounded-xl border border-gray-100">
                  <CheckCircle2 className="w-4 h-4 text-[#F05535] shrink-0" />
                  <span>Comprehensive SOP Training</span>
                </div>
                <div className="flex items-center gap-2.5 text-xs font-bold text-[#343538] bg-[#F7F7F7] p-2.5 rounded-xl border border-gray-100">
                  <DollarSign className="w-4 h-4 text-[#F05535] shrink-0" />
                  <span>Competitive Royalty Structure</span>
                </div>
                <div className="flex items-center gap-2.5 text-xs font-bold text-[#343538] bg-[#F7F7F7] p-2.5 rounded-xl border border-gray-100">
                  <ShieldCheck className="w-4 h-4 text-[#F05535] shrink-0" />
                  <span>100% Halal Supply Chain</span>
                </div>
                <div className="flex items-center gap-2.5 text-xs font-bold text-[#343538] bg-[#F7F7F7] p-2.5 rounded-xl border border-gray-100">
                  <Building2 className="w-4 h-4 text-[#F05535] shrink-0" />
              ...
              <div className="mt-8">
                <button
                  ...
                  className="bg-[#F05535] hover:bg-[#D34518] text-white px-7 py-4 rounded-xl font-bold text-base shadow-lg shadow-red-900/20 hover:shadow-xl transition-all flex items-center gap-3 cursor-pointer"
                >
                  <span>Franchise Opportunities</span>
                  <ArrowRight className="w-5 h-5 text-[#F6A18F]" />
                </button>
              </div>
