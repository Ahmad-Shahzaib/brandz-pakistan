...
export const BrandStory: React.FC<{ image: string; content?: ContentCard }> = ({ image, content }) => {
  return (
          ...
          >
            <div className="relative w-full max-w-lg">
              ...
              >
                <img
                  src={image}
                  alt={content?.title || 'Brandz Pakistan food and hospitality'}
