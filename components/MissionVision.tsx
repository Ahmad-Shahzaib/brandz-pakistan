    ...
    <section className="py-20 bg-[#FAF8F7] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-[#1A1818] mt-3">
            Our Purpose & Ambition
          </h2>
          <p className="text-[#6B655C] text-base mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="bg-[#E51821] text-white rounded-3xl p-8 sm:p-10 shadow-xl shadow-red-900/15 relative overflow-hidden flex flex-col justify-between group"
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-8">
                <div className="w-14 h-14 rounded-full bg-white text-[#E51821] flex items-center justify-center shadow-lg font-bold">
          ...
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="bg-[#1A1818] text-white border border-white/10 rounded-3xl p-8 sm:p-10 shadow-xl relative overflow-hidden flex flex-col justify-between group"
          >
            {/* Background Decorative Circles */}
            <div className="absolute -right-12 -bottom-12 w-48 h-48 rounded-full bg-[#E51821]/20 pointer-events-none group-hover:scale-125 transition-transform duration-700" />

            <div>
              <div className="flex items-center justify-between mb-8">
                <div className="w-14 h-14 rounded-full bg-[#FFC700] text-[#1A1818] flex items-center justify-center shadow-lg font-bold">
                  <Eye className="w-7 h-7" />
                </div>
                <span className="text-xs uppercase font-extrabold tracking-widest bg-[#FFC700]/20 text-[#FFC700] px-3 py-1 rounded-full border border-[#FFC700]/30">
                  Our Vision
                </span>
              </div>
