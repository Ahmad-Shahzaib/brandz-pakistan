      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
          <motion.div
            ...
            className="bg-[#1A1818] rounded-3xl max-w-4xl w-full overflow-hidden shadow-2xl border border-white/20 relative text-white"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-white/10 bg-black/40">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#E51821] text-white flex items-center justify-center font-bold">
                  <Film className="w-5 h-5 text-[#FFC700]" />
                </div>
                <div>
            ...
            <div className="relative aspect-video bg-black flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <div className="w-20 h-20 rounded-full bg-[#E51821]/90 text-white flex items-center justify-center shadow-2xl animate-pulse">
                  <Play className="w-10 h-10 fill-[#FFC700] text-[#FFC700] ml-1" />
                </div>
                <p className="mt-4 font-bold text-sm tracking-wider uppercase text-[#FFC700]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent flex flex-col gap-2">
                <div className="w-full h-1.5 bg-white/20 rounded-full overflow-hidden">
                  <div className="h-full bg-[#E51821] w-3/5 rounded-full" />
                </div>
                <div className="flex items-center justify-between text-xs text-gray-300">
                  <div className="flex items-center gap-3">
                    <span className="font-mono font-bold text-white">01:38 / 02:45</span>
                    <span className="hidden sm:inline-flex items-center gap-1 text-[#FFC700] text-[10px] font-bold bg-white/10 px-2 py-0.5 rounded">
            ...
            {/* Footer Information */}
            <div className="p-4 sm:p-6 bg-[#111010] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
              <p>
                Filmed across MM Alam Corporate HQ, Kot Lakhpat Central Processing Hub, and Flagship Outlets in Lahore.
              </p>
              <button
                onClick={onClose}
                className="bg-[#E51821] hover:bg-[#B80F16] text-white px-5 py-2 rounded-xl font-bold transition-all text-xs cursor-pointer shrink-0"
              >
                Close Trailer
              </button>
            </div>
