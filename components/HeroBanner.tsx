...
export const HeroBanner: React.FC = () => {
  return (
    <section className="relative pt-24 pb-16 md:pt-28 md:pb-20 overflow-hidden bg-[#1A1818]">
      ...
      <div className="absolute inset-0 z-0 opacity-40">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#1A1818] via-transparent to-black/50" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#FFC700] text-[#1A1818] px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-4 shadow-sm">
                <Sparkles className="w-3.5 h-3.5 fill-[#1A1818]" />
              ...
              <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight">
                About <span className="text-[#FFC700] relative inline-block">
                  Fri-Chiks ®
                  <svg className="absolute -bottom-2 left-0 w-full h-3 text-[#E51821]" viewBox="0 0 100 20" preserveAspectRatio="none">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Link
                  href="/apply"
                  className="bg-[#E51821] hover:bg-[#B80F16] text-white px-6 py-3.5 rounded-xl font-bold text-sm sm:text-base shadow-lg shadow-red-900/40 hover:-translate-y-0.5 transition-all flex items-center gap-2 cursor-pointer"
                >
          ...
          <div className="lg:col-span-4 relative flex justify-center lg:justify-end mt-6 lg:mt-0">
            ...
            >
              {/* Decorative Glow */}
              <div className="absolute -inset-4 bg-gradient-to-r from-[#E51821] to-[#FFC700] opacity-30 blur-2xl rounded-full" />

              {/* Fri-Chiks Emblem Card */}
              <div className="relative bg-[#1A1818]/90 backdrop-blur-md border border-white/20 rounded-3xl p-6 shadow-2xl text-white">
                <div className="flex items-center justify-between pb-4 border-b border-white/10">
                  <span className="text-xs uppercase font-extrabold tracking-widest text-[#FFC700]">
                    EST. 2002
                  </span>
                  <div className="bg-[#E51821] text-white px-2.5 py-1 rounded-lg text-xs font-bold flex items-center gap-1">
                ...
                <div className="pt-3 border-t border-white/10 flex items-center justify-between text-xs text-gray-300">
                  ...
                  <span className="text-[#FFC700] font-bold">Expansion Mode</span>
                </div>
              </div>
            </motion.div>
          </div>
